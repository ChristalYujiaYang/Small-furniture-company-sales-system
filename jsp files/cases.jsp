							...
							<div class="tidjfh">
								<div class="ssdjgds">
									...
									<div class="kjdfgdfg">
										...
										<a href="${pageContext.request.contextPath}/news2servlet">行业新闻</a>
						...
						<div class="c8right">
							<div class="c8dsfsdf jhdfdgf">
								<div class="toubudfg jksdfsd">
									当前位置：
									<a href="${pageContext.request.contextPath}/MainpageServlet">首页
									</a>&gt;<a href="${pageContext.request.contextPath}/OutcomeServlet">成功案例</a>
								</div>
							</div>
							<div class="sdlkjfksdgf">
								<div class="sdijfgisddsg">
									<c:forEach items="${requestScope.findcases}" var="cases">
										<table align="center">
											<tr>
												<td align="center" width="500px">
													<div id="Contain">
														<img id="BigImage" src="${cases.photo1}" />
													</div>
													<div id="SmallImg">
														<img src="${cases.photo1}" alt="图片无法显示" />
														<img src="${cases.photo2}" alt="图片无法显示" />
														<img src="${cases.photo3}" alt="图片无法显示" />
														<img src="${cases.photo4}" alt="图片无法显示" />
														<img src="${cases.photo5}" alt="图片无法显示" />
														<img src="${cases.photo6}" alt="图片无法显示" />
														<img src="${cases.photo7}" alt="图片无法显示" />
													</div>
												</td>
											</tr>
											<tr>
			...
			<div class="contnet6">
				<div class="kjhnjdsnj">
					...
					<div class="klsndkfdsf">
						...
						<a target="_blank" href="http://www.ju9ju.com" title="重庆融香植物花卉园林网"><img
						...
						<a target="_blank" href="http://www.51aspx.com" title="51ASPX"><img
								src="<%=request.getContextPath()%>/images/51aspx.png" width="88"
								height="31" /> </a>
